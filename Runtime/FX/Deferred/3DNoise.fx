...
const static float2	NoiseDelta = float2( INV_LATTICE_SIZE, 0 );
...
float NHQu(float3 _UVW, Texture3D _Noise, const float smooth = 1) 
{
	...
	float4	f1 = float4( _Noise.SampleLevel(NearestWrap, FloorUVW + NoiseDelta.xxx, 0).x, 
						 _Noise.SampleLevel(NearestWrap, FloorUVW + NoiseDelta.yxx, 0).x, 
						 _Noise.SampleLevel(NearestWrap, FloorUVW + NoiseDelta.xyx, 0).x, 
						 _Noise.SampleLevel(NearestWrap, FloorUVW + NoiseDelta.yyx, 0).x );
	float4	f2 = float4( _Noise.SampleLevel(NearestWrap, FloorUVW + NoiseDelta.xxy, 0).x, 
						 _Noise.SampleLevel(NearestWrap, FloorUVW + NoiseDelta.yxy, 0).x, 
						 _Noise.SampleLevel(NearestWrap, FloorUVW + NoiseDelta.xyy, 0).x, 
						 _Noise.SampleLevel(NearestWrap, FloorUVW + NoiseDelta.yyy, 0).x );
	...
	float4	f2 = _Noise.SampleLevel(NearestWrap, FloorUVW + NoiseDelta.xyy, 0);	// <+x, +xy, +xz, +xyz>
