...
namespace Nuaj.Cirrus
{
	...
	public class RenderTechniqueScene : RenderTechniqueDefault
	{
		...
		protected bool						m_bPreMultiplyByAlpha = true;
		...
		public bool					PreMultiplyByAlpha	{ get { return m_bPreMultiplyByAlpha; } set { m_bPreMultiplyByAlpha = value; } }
		...
		public RenderTechniqueScene( Device _Device, string _Name ) : base( _Device, _Name )
		{
			...
			m_Material = ToDispose( new Material<VS_P3N3G3T2>( m_Device, "Scene Material", ShaderModel.SM4_0, new System.IO.FileInfo( "FX/VolumeMeshBuilder/SceneRendering.fx" ) ) );
		}
...
//			m_Device.SetStockRasterizerState( Device.HELPER_STATES.NO_CULLING );
			...
			using ( m_Material.UseLock() )
			{
				...
				CurrentMaterial.GetVariableByName( "PreMultiplyByAlpha" ).AsScalar.Set( m_bPreMultiplyByAlpha );
