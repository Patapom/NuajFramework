		...
		protected AdobeColors.HSL GetColor(int x, int y)
		{
			...
			switch ( m_DrawStyle )
			{
				...
				case ColorPickerForm.DRAW_STYLE.Brightness :
					...
					break;
				case ColorPickerForm.DRAW_STYLE.Red :
					Result = AdobeColors.RGB_to_HSL( new Vector3( m_RGB.X, (float) (1.0 - y * InvHeight), (float) (x * InvWidth) ) );
					break;
				case ColorPickerForm.DRAW_STYLE.Green :
					Result = AdobeColors.RGB_to_HSL( new Vector3( (float) (1.0 - y * InvHeight), m_RGB.Y, (float) (x * InvWidth) ) );
					break;
				case ColorPickerForm.DRAW_STYLE.Blue :
					Result = AdobeColors.RGB_to_HSL( new Vector3( (float) (x * InvWidth), (float) (1.0 - y * InvHeight), m_RGB.Z ) );
					break;
			}
