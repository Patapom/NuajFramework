...
{
	/// <summary>
	/// This percomputer generates motion textures to animation grass & branch trees
...
// 					byte	I = (byte) (255 * Out[2*(256*Y+X)+1] / 65536.0);
			...
			//////////////////////////////////////////////////////////////////////////
			// Save the results
			System.IO.FileInfo		F = new System.IO.FileInfo( @"..\..\..\..\Runtime\Media\MotionTextures\Motion0_256x256.complex" );
