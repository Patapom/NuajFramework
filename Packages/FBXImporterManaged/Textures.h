...
namespace FBXImporter
{
	...
	public:		// METHODS
		...
		Texture( Scene^ _ParentScene, KFbxTexture* _pTexture ) : BaseObject( _ParentScene, _pTexture )
		{
			...
			m_Translation = Helpers::ToVector( _pTexture->Translation.Get() );
			m_Rotation = Helpers::ToVector( _pTexture->Rotation.Get() );
			m_Scale = Helpers::ToVector( _pTexture->Scaling.Get() );
