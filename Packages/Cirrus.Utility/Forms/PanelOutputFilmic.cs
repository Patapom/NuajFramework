...
{
	public partial class PanelOutputFilmic : Panel
	{
		protected const int		STEPS_COUNT = 1000;

		public Bitmap		m_Bitmap = null;

		public float		m_HDRMaxIntensity = 10.0f;
		public float		m_ExposureBias = 1.0f;
		...
		public PanelOutputFilmic()
		{
			InitializeComponent();
		}

		public PanelOutputFilmic( IContainer container )
		{
			container.Add( this );
...
// 		public float F = 0.30f;	// F = Toe Denominator
		...
		{
			return m_LDRWhitePoint * FilmicOperator( m_ExposureBias * _HDRLuminance ) / Math.Max( 1e-3f, FilmicOperator( m_HDRWhitePoint ) );
//			return m_LDRWhitePoint * FilmicOperator( m_ExposureBias * _HDRLuminance / Math.Max( 1e-3f, m_HDRWhitePoint * m_HDRMaxIntensity ) );
		}
