...
namespace Nuaj.Cirrus.FBX
{
	...
	/// 1) Create an empty cirrus scene
	...
	/// 
	/// Once the FBX scene is loaded, you can save the scene into a Cirrus scene format and shouldn't need the FBX format anymore
	/// (i.e. FBX is only a DEBUG mode format that should NOT be used at runtime as Cirrus scenes are much more lightweight).
	/// </summary>
	/// <remarks>
...
// 						m_Pivot = null;
			...
			/// <summary>
			/// Performs mesh consolidation and builds missing tangent space
			/// </summary>
...
// 		}
		...
		{
			if ( _FileName == null )
				throw new NException( this, "Invalid file name !" );
			if ( !_FileName.Exists )
				throw new NException( this, "Scene file \"" + _FileName + "\" does not exist !" );
			if ( _Scene == null )
				throw new NException( this, "Invalid Cirrus Scene to load into !" );
			if ( _MaterialMap == null )
				throw new NException( this, "Invalid material map for material conversion !" );
			...
			{
				throw new NException( this, "An error occurred while importing the FBX file \"" + _FileName + "\" !", _e );
			}
			finally
			{
				FBXScene.Dispose();
