...
namespace Nuaj
{
	...
	/// </remarks>
	public class Bitmap2 : Component
	{
		#region CONSTANTS
		...
		{
			Vector4		XYZ2RGB( Vector4 _XYZ );
			Vector4		RGB2XYZ( Vector4 _RGB );
			void		XYZ2RGB( Vector4[,] _XYZ );
			void		RGB2XYZ( Vector4[,] _RGB );
		}
		...
		public class	ColorProfile : IColorConverter
		{
			...
			public static readonly Vector2	ILLUMINANT_A	= new Vector2( 0.44757f, 0.40745f );	// Incandescent, tungsten
			public static readonly Vector2	ILLUMINANT_D50	= new Vector2( 0.34567f, 0.35850f );	// Daylight, Horizon
			public static readonly Vector2	ILLUMINANT_D55	= new Vector2( 0.33242f, 0.34743f );	// Mid-Morning, Mid-Afternoon
			public static readonly Vector2	ILLUMINANT_D65	= new Vector2( 0.31271f, 0.32902f );	// Daylight, Noon, Overcast
			public static readonly Vector2	ILLUMINANT_E	= new Vector2( 1/3.0f, 1/3.0f );		// Reference
			...
			{
				public Vector2		R, G, B, W;

				public static Chromaticities	sRGB			= new Chromaticities() { R = new Vector2( 0.6400f, 0.3300f ), G = new Vector2( 0.3000f, 0.6000f ), B = new Vector2( 0.1500f, 0.0600f ), W = ILLUMINANT_D65 };
				public static Chromaticities	AdobeRGB_D50	= new Chromaticities() { R = new Vector2( 0.6400f, 0.3300f ), G = new Vector2( 0.2100f, 0.7100f ), B = new Vector2( 0.1500f, 0.0600f ), W = ILLUMINANT_D50 };
				public static Chromaticities	AdobeRGB_D65	= new Chromaticities() { R = new Vector2( 0.6400f, 0.3300f ), G = new Vector2( 0.2100f, 0.7100f ), B = new Vector2( 0.1500f, 0.0600f ), W = ILLUMINANT_D65 };
				public static Chromaticities	ProPhoto		= new Chromaticities() { R = new Vector2( 0.7347f, 0.2653f ), G = new Vector2( 0.1596f, 0.8404f ), B = new Vector2( 0.0366f, 0.0001f ), W = ILLUMINANT_D50 };
				public static Chromaticities	Radiance		= new Chromaticities() { R = new Vector2( 0.6400f, 0.3300f ), G = new Vector2( 0.2900f, 0.6000f ), B = new Vector2( 0.1500f, 0.0600f ), W = ILLUMINANT_E };
				...
				private bool	Equals( Vector2 a, Vector2 b )
				{
			...
			protected class		InternalColorConverter_sRGB : IColorConverter
			{
				...
				public static readonly Matrix	MAT_RGB2XYZ = new Matrix(
				...
				public static readonly Matrix	MAT_XYZ2RGB = new Matrix(
				...
				public Vector4 XYZ2RGB( Vector4 _XYZ )
				{
					// Transform into RGB
					_XYZ = Vector4.Transform( _XYZ, MAT_XYZ2RGB );
				...
				public Vector4 RGB2XYZ( Vector4 _RGB )
				{
					// Gamma un-correct
					...
					// Transform into XYZ
					return Vector4.Transform( _RGB, MAT_RGB2XYZ );
				}

				public void XYZ2RGB( Vector4[,] _XYZ )
				{
					...
					for ( int Y=0; Y < H; Y++ )
						for ( int X=0; X < W; X++ )
						{
							Vector4	XYZ = _XYZ[X,Y];

							// Transform into RGB
							XYZ = Vector4.Transform( XYZ, MAT_XYZ2RGB );
				...
				public void RGB2XYZ( Vector4[,] _RGB )
				{
					...
					for ( int Y=0; Y < H; Y++ )
						for ( int X=0; X < W; X++ )
						{
							...
							// Transform into XYZ
							_RGB[X,Y] = Vector4.Transform( RGB, MAT_RGB2XYZ );
						}
				}
			...
			protected class		InternalColorConverter_Radiance : IColorConverter
			{
				...
				{
					// Transform into RGB
					return Vector4.Transform( _XYZ, MAT_XYZ2RGB );
				}
				...
				public void XYZ2RGB( Vector4[,] _XYZ )
				{
					...
					for ( int Y=0; Y < H; Y++ )
						for ( int X=0; X < W; X++ )
							_XYZ[X,Y] = Vector4.Transform( _XYZ[X,Y], MAT_XYZ2RGB );
				}
				...
				public void RGB2XYZ( Vector4[,] _RGB )
				{
					...
					for ( int Y=0; Y < H; Y++ )
						for ( int X=0; X < W; X++ )
							_RGB[X,Y] = Vector4.Transform( _RGB[X,Y], MAT_RGB2XYZ );
				}
			...
			{
				protected Matrix	m_RGB2XYZ;
				protected Matrix	m_XYZ2RGB;

				public InternalColorConverter_Generic_NoGamma( Matrix _RGB2XYZ, Matrix _XYZ2RGB )
				{
					m_RGB2XYZ = _RGB2XYZ;
					m_XYZ2RGB = _XYZ2RGB;
				}
				...
				{
					// Transform into RGB
					return Vector4.Transform( _XYZ, m_XYZ2RGB );
				}

				public Vector4 RGB2XYZ( Vector4 _RGB )
				{
					// Transform into XYZ
					return Vector4.Transform( _RGB, m_RGB2XYZ );
				}
				...
				public void XYZ2RGB( Vector4[,] _XYZ )
				{
					...
					for ( int Y=0; Y < H; Y++ )
						for ( int X=0; X < W; X++ )
							_XYZ[X,Y] = Vector4.Transform( _XYZ[X,Y], m_XYZ2RGB );
				}
				...
				public void RGB2XYZ( Vector4[,] _RGB )
				{
					...
					for ( int Y=0; Y < H; Y++ )
						for ( int X=0; X < W; X++ )
							_RGB[X,Y] = Vector4.Transform( _RGB[X,Y], m_RGB2XYZ );
				}
			...
			protected class		InternalColorConverter_Generic_StandardGamma : IColorConverter
			{
				...
				public InternalColorConverter_Generic_StandardGamma( Matrix _RGB2XYZ, Matrix _XYZ2RGB, float _Gamma )
				{
					m_RGB2XYZ = _RGB2XYZ;
					m_XYZ2RGB = _XYZ2RGB;
					m_Gamma = _Gamma;
				...
				{
					// Transform into RGB
					_XYZ = Vector4.Transform( _XYZ, m_XYZ2RGB );
				...
				public void XYZ2RGB( Vector4[,] _XYZ )
				{
					...
					for ( int Y=0; Y < H; Y++ )
						for ( int X=0; X < W; X++ )
						{
							...
							// Transform into RGB
							XYZ = Vector4.Transform( XYZ, m_XYZ2RGB );
				...
				public void RGB2XYZ( Vector4[,] _RGB )
				{
					...
					for ( int Y=0; Y < H; Y++ )
						for ( int X=0; X < W; X++ )
						{
							...
							// Transform into XYZ
							_RGB[X,Y] = Vector4.Transform( RGB, m_RGB2XYZ );
						}
				}
			...
			protected class		InternalColorConverter_Generic_sRGBGamma : IColorConverter
			{
				...
				public InternalColorConverter_Generic_sRGBGamma( Matrix _RGB2XYZ, Matrix _XYZ2RGB )
				{
					m_RGB2XYZ = _RGB2XYZ;
					m_XYZ2RGB = _XYZ2RGB;
				}
			...
			protected class		InternalColorConverter_Generic_ProPhoto : IColorConverter
			{
				...
				public InternalColorConverter_Generic_ProPhoto( Matrix _RGB2XYZ, Matrix _XYZ2RGB )
				{
					m_RGB2XYZ = _RGB2XYZ;
					m_XYZ2RGB = _XYZ2RGB;
				}
			...
			protected Matrix			m_RGB2XYZ = Matrix.Identity;
			protected Matrix			m_XYZ2RGB = Matrix.Identity;
			...
			/// </summary>
			public Matrix			MatrixRGB2XYZ			{ get { return m_RGB2XYZ; } }

			/// <summary>
			/// Gets the transform to convert CIEXYZ to RGB
			/// </summary>
			public Matrix			MatrixXYZ2RGB			{ get { return m_XYZ2RGB; } }
			...
			protected void	BuildTransformFromChroma( bool _bCheckGammaCurveOverride )
			{
				...
				m_RGB2XYZ.Row1 = new Vector4( Sum_RGB.X * xyz_R, 0.0f );
				m_RGB2XYZ.Row2 = new Vector4( Sum_RGB.Y * xyz_G, 0.0f );
				m_RGB2XYZ.Row3 = new Vector4( Sum_RGB.Z * xyz_B, 0.0f );
...
// 					} )
		...
		protected Vector4[,]		m_Bitmap = null;		// CIEXYZ Bitmap content + Alpha
		...
		public Vector4[,]	ContentXYZ				{ get { return m_Bitmap; } }
...
// 								Converter.EndInit();
// 
// 								int		Stride = Frame.PixelWidth * Utilities.SizeOf<Vector4>();
...
// DEBUG
		...
		protected void	ConvertFrame( BitmapSource _Frame )
		{
			...
			{	
				...
				Vector4[]	Palette = new Vector4[_Frame.Palette.Colors.Count];
				for ( int i=0; i < Palette.Length; i++ )
				{
					System.Windows.Media.Color	C = _Frame.Palette.Colors[i];
					Palette[i] = new Vector4(
						C.R * BYTE_TO_FLOAT,
						C.G * BYTE_TO_FLOAT,
						C.B * BYTE_TO_FLOAT,
						C.A * BYTE_TO_FLOAT );
...
*/
		...
		/// <returns></returns>
		public static Vector4[,]	LoadAndDecodeHDRFormat( byte[] _HDRFormatBinary, bool _bTargetNeedsXYZ, out ColorProfile _ColorProfile )
		{
			bool	bSourceIsXYZ;
		...
		public static Vector4[,]	DecodeRGBEImage( PF_RGBE[,] _Source, bool _bSourceIsXYZ, bool _bTargetNeedsXYZ, ColorProfile _ColorProfile )
		{
			if ( _Source == null )
				return	null;
		...
		/// <param name="_bTargetNeedsXYZ">Tells if the target needs to be in CIE XYZ space (true) or RGB (false)</param>
		/// <param name="_ColorProfile">The color profile for the image</param>
		public static void			DecodeRGBEImage( PF_RGBE[,] _Source, bool _bSourceIsXYZ, Vector4[,] _Target, bool _bTargetNeedsXYZ, ColorProfile _ColorProfile )
		{
