...
namespace FMOD
{
    ...
    */
    internal enum SOUNDGROUP_BEHAVIOR
    {
    ...
    */
    internal enum SYSTEM_CALLBACKTYPE
    {
    ...
    */
    internal enum CHANNEL_CALLBACKTYPE
    {
    ...
    */
    internal class REVERB_PROPERTIES
    ...
    */
    internal class REVERB_CHANNELFLAGS
    {
    ...
    */
    internal class DSP
    {
        ...
        internal RESULT addInput                  (DSP target, ref DSPConnection dspconnection)
        {
            RESULT result = RESULT.OK;
            IntPtr dspconnectionraw = new IntPtr();
            DSPConnection dspconnectionnew = null;
