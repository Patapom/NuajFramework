...
namespace Demo
{
	public partial class DemoForm : Form
	{
		...
		protected RenderTechniqueDistanceField	m_RenderTechniqueDistanceField = null;	// The advanced render technique for distance field ray-tracing
		...
		public DemoForm()
		{
			...
			m_RenderTechniqueDistanceField = ToDispose( new RenderTechniqueDistanceField( m_Device, "Caustics Render Technique" ) );
			m_Renderer.Renderer.FindPipeline( Pipeline.TYPE.MAIN_RENDERING ).InsertTechnique( 0, m_RenderTechniqueDistanceField );	// Insert our technique at the beginning

			m_RenderTechniqueDistanceField.Camera = m_Renderer.Camera;
		...
		public void	RunMessageLoop()
		{
			...
			CamManip.InitializeCamera( new Vector3( 0.0f, 2.0f, 4.0f ), new Vector3( 0.0f, 1.0f, 0.0f ), Vector3.UnitY );
			...
			SharpDX.Windows.RenderLoop.Run( this, () =>
			{
				...
				m_RenderTechniqueDistanceField.Time = fTotalTime;
...
// 			{
// 				case 0:
// 					m_RenderTechniqueDistanceField.SpherePosition = _NewPosition;
// 					break;
// 				case 1:
// 					m_RenderTechniqueDistanceField.LightPosition = _NewPosition;
// 					break;
// 			}
		}
