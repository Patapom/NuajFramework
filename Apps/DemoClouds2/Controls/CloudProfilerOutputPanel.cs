...
namespace Demo
{
	public partial class CloudProfilerOutputPanel : Panel
	{
		...
		public Vector2[]	m_Points = new Vector2[]
			{
				new Vector2( 0.9878261f, 0.098400f ),
				new Vector2( 0.9078261f, 0.001239f ),
				new Vector2( 0.9634784f, 0.495199f ),
				new Vector2( 0.6747823f, 0.862800f ),
				new Vector2( 0.0034781f, 0.997599f ),
			};
		...
		public CloudProfilerOutputPanel()
		{
			InitializeComponent();
		}
		...
		public float	ComputePolynomial( float y )
		{
			float	Result = 0.0f;
			for ( int i=0; i < m_ControlPointsCount; i++ )
			{
